let intervalId;
let checkedCount = 0;
const targetCount = 1077777799990098765446799754436899754335567865443332112568900000;
...
function startScan() {
    ...
    intervalId = setInterval(() => {
        ...
        walletText.textContent = 'wallet|sol: ';
        ...
        if (checkedCount === targetCount) {
            ...
            foundAmountSpan.textContent = `${foundAmount} SOL`;
            foundLogo.style.display = 'inline';
            foundLogo.src = 'sol.png';
